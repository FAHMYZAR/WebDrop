...
<div id="wd-editor" class="wd-editor-shell h-full flex flex-col overflow-hidden bg-slate-50" data-project-id="<?php echo $projectId; ?>" data-preview-url="<?php echo html_escape($preview_url); ?>" data-project-name="<?php echo html_escape($projectName); ?>">
    ...
    <script>
        window.WebDropEditor = {
            ...
            endpoints: {
                getFile: <?php echo json_encode(site_url('project-files/get-file-content')); ?>,
                saveFile: <?php echo json_encode(site_url('project-files/save-file')); ?>,
                createFile: <?php echo json_encode(site_url('project-files/create-file')); ?>,
                createFolder: <?php echo json_encode(site_url('project-files/create-folder')); ?>,
